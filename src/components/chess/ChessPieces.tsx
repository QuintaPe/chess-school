...
// Source: Wikimedia Commons / Lichess (cburnett style) defined as React components

export const WhitePawn = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
...
export const WhiteKnight = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
...
export const WhiteBishop = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
        <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const WhiteRook = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
...
export const WhiteQueen = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
        <g fill="#fff" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const WhiteKing = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
        <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const BlackPawn = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
...
export const BlackKnight = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
        <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const BlackBishop = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
        <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const BlackRook = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
...
export const BlackQueen = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
        <g fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
            <g stroke="none">
...
export const BlackKing = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 45 45" className="w-full h-full" {...props}>
        <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export const PieceMap: Record<string, React.ComponentType<React.SVGProps<SVGSVGElement>>> = {
    'P': WhitePawn,
    'N': WhiteKnight,
    'B': WhiteBishop,
    'R': WhiteRook,
